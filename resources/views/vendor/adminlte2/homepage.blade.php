...
<head>
    ...
    <meta name="description" content="DigitalStudio.ID - __('homepage.description') ">
    <meta name="author" content="Sergi Tur Badenas - acacha.org">

    <meta property="og:title" content="Adminlte-laravel" />
    <meta property="og:type" content="website" />
    <meta property="og:description" content="DigitalStudio.ID - __(homepage.description)" />
        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#home" class="smoothScroll">@lang('homepage.menuhome')</a></li>
                    <li><a href="#desc" class="smoothScroll">@lang('homepage.menudescription')</a></li>
                    <li><a href="#showcase" class="smoothScroll">@lang('homepage.menushowcase')</a></li>
                    <li><a href="#contact" class="smoothScroll">@lang('homepage.menucontact')</a></li>
                </ul>
                <ul class="nav navbar-nav navbar-right">
                    @if (Auth::guest())
                        <li><a href="{{ url('/login') }}">@lang('homepage.menulogin')</a></li>
                        <li><a href="{{ url('/register') }}">@lang('homepage.menuregister')</a></li>
                    @else
        ...
        <div class="container">
            <div class="row centered">
                <div class="col-lg-12">
                    ...
                    <h3>A <a href="https://laravel.com/">Laravel</a> 5 package that switchs default Laravel scaffolding/boilerplate to <a href="https://almsaeedstudio.com/preview">AdminLTE</a> template with
